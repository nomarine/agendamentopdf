...
function Table($link, $query, $prop=array())
{
	...
	if(!isset($prop['color2']))
		$prop['color2']=array();
	if(!isset($prop['textcolor1']))
		$prop['textcolor1']=array();
	if(!isset($prop['textcolor2']))
		$prop['textcolor2']=array();
	$this->RowColors=array($prop['color1'],$prop['color2'],$prop['textcolor1'],$prop['textcolor2']);
